...
from django_mail.utils import send_email_with_attachment
...
recursive-include django_mail *.html *.png *.gif *js *.css *jpg *jpeg *svg *py
```
...
## 安装使用
```bash
pip install dist\django_mail-1.0.0-py2.py3-none-any.whl
```
